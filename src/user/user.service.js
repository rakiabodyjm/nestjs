...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (createUserInput) {
        var newUser = this.userRepository.create(createUserInput);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tobeUpdated = _a.sent();
                        return [2 /*return*/, this.userRepository.save(__assign(__assign(__assign({}, tobeUpdated), updateUserInput), { id: id }))
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, "User ID: " + id + " removed"];
                    case 2:
                        err_1 = _a.sent();
