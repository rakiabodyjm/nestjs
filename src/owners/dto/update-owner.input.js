...
var create_owner_input_1 = require("./create-owner.input");
var graphql_1 = require("@nestjs/graphql");
var pet_entity_1 = require("../../pets/pet.entity");
var UpdateOwnerInput = /** @class */ (function (_super) {
    __extends(UpdateOwnerInput, _super);
    function UpdateOwnerInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        graphql_1.Field(function () { return graphql_1.Int; })
    ], UpdateOwnerInput.prototype, "id");
    __decorate([
        graphql_1.Field({ nullable: true })
    ], UpdateOwnerInput.prototype, "name");
    __decorate([
        graphql_1.Field(function () { return [graphql_1.Int]; }, { nullable: true })
    ], UpdateOwnerInput.prototype, "pets");
    UpdateOwnerInput = __decorate([
        graphql_1.InputType()
    ], UpdateOwnerInput);
    return UpdateOwnerInput;
}(graphql_1.PartialType(create_owner_input_1.CreateOwnerInput)));
